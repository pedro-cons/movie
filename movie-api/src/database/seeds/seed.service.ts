  ...
  private async seed() {
    ...
    const movies = await this.movieRepo.save([
      ...
      this.movieRepo.create({
        ...
        description:
          "A faded television actor and his stunt double strive to achieve fame and success in the final years of Hollywood's Golden Age.",
      ...
      this.movieRepo.create({
        ...
        description:
          "Eight years after the Joker's reign of anarchy, Batman must return to defend Gotham City against Bane.",
    ...
    await this.ratingRepo.save([
      ...
      this.ratingRepo.create({
        value: 9,
        comment: "Epic superhero ensemble",
        movieId: movies[2].id,
      }),
      this.ratingRepo.create({
        value: 7,
        comment: "Started the MCU revolution",
        movieId: movies[3].id,
      }),
      this.ratingRepo.create({
        value: 10,
        comment: "DiCaprio deserved the Oscar for this",
        movieId: movies[4].id,
      }),
      this.ratingRepo.create({
        value: 8,
        comment: "Great conclusion to the trilogy",
        movieId: movies[5].id,
      }),
    ]);
  }
